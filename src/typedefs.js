 ...
 * @property { enumSvelteKVPoint } point Would you love this.get() and this.put() to use to api or platform
 * @property { boolean } doJSONParse On .get() would you love a JSON.parse() to happen
 * @property { boolean } doJSONStringify On .put() would you love a JSON.stringify() to happen
